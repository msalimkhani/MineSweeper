    ...
    private Home(String iconPath)
    {
        ...
        btnEight.addMouseListener(new MouseAdapter() {
            ...
            public void mouseClicked(MouseEvent e) {
                MineSweeper.getInstance(8, 8, iconPath, _frame);
            }
        });
        ...
        btnTen.addMouseListener(new MouseAdapter() {
            @Override
            public void mouseClicked(MouseEvent e) {
                MineSweeper.getInstance(10, 10, iconPath, _frame);
            }
        });
        ...
        btnTwelve.addMouseListener(new MouseAdapter() {
            @Override
            public void mouseClicked(MouseEvent e) {
                MineSweeper.getInstance(12, 12, iconPath, _frame);
            }
        });
        ...
        btnForteen.addMouseListener(new MouseAdapter() {
            @Override
            public void mouseClicked(MouseEvent e) {
                MineSweeper.getInstance(14, 14, iconPath, _frame);
            }
        });
